...
- **pgwt-1 is the second time this repo has nearly shipped a capability its operators could
  ...
  coverage without naming the stored representation an operator actually produces. AC9 exists
  to make a fixture-only proof insufficient.
